  ...
  <main id="meta-app" class="white" style="width: 100%" v-cloak>
    <div class="p-1 grey lighten-3">
            ...
            <div class="col s12 m8">
              <div class="d-flex align-items-center justify-content-around">
                <div class="d-flex align-items-center">
                  <p class="p-0">Size</p>
                  <select
                    class="browser-default size-select white-text"
                ...
                <form
                  ...
                  class="d-flex flex-wrap align-items-center justify-content-center m-1"
                >
                  <input
                    v-model="query_term"
                    type="text"
                  ...
                  <button
                    v-if="query_term"
                    class="smallButton green white-text"
                  ...
                  <button
                    v-if="query_term"
                    @click="clear()"
                    class="smallButton red white-text"
                    type="button"
                  >
                    Clear
                  </button>
      ...
      <div class="row m-0 lighten-5" :class="[!generalMode ? 'purple' : 'cyan ']">
        <!-- GRAPH and RESULTS-->
        <div
          class="col s3 p-1 operations-menu grey darken-1"
          style="padding-bottom: 20px; min-height: 700px"
        >
          <h6 class="white-text"><b>Overview</b></h6>
          <small class="white-text">Based on the current query: </small>
          <table
            class="white-text highlight grey darken-2"
            style="font-size: smaller; margin-bottom: 5px"
          >
            <thead>
              <th class="p-small"></th>
              <th class="p-small">
                ...
                <i
                  ...
                  data-tippy-content="Edges and APIs matching current criteria and size constraints."
                  >info</i
                >
              </th>
              <th class="p-small">
                ...
                <i
                  class="material-icons tiny cyan-text"
                  data-tippy-content="Total edges and APIs available matching search criteria some may not be included due to size constraints set. You can increase size to include more results."
                  >info</i
                >
              </th>
            </thead>
            <tbody>
              <tr>
                ...
                <td
                  class="p-small scale-in-center lime-text"
                  v-text="total < size ? numberWithCommas(total) : size"
                ></td>
                <td class="p-small scale-in-center">
                  ...
                  <template v-if="results.length < total">
                    <i
                      style="z-index: 100"
                      class="fa fa-exclamation-circle orange-text m-1"
              ...
              <tr>
                ...
                <td class="p-small scale-in-center">
                  <details>
                    ...
                    <ul>
                      <li v-for="item in subjectTotalFromResponse" :key="item.term + 'sub'">
                        {{ item.term }}
                      </li>
                    </ul>
                  </details>
              ...
              <tr>
                ...
                <td class="p-small scale-in-center">
                  <details>
                    ...
                    <ul>
                      <li v-for="item in objectTotalFromResponse" :key="item.term + 'obj'">
                        {{ item.term }}
                      </li>
                    </ul>
                  </details>
          ...
          >
            <summary>
              <p style="margin: 0; display: inline">
                ...
                <a
                  target="_blank"
                  :href="'https://biolink.github.io/biolink-model/docs/' + hit.object"
                >
                  <i class="fa fa-external-link" aria-hidden="true"></i>
                </a>
              </p>
        ...
        <div class="col s9" style="padding: 0px">
          <div style="position: relative">
            ...
            <div class="graph-btn-container">
              <button
                class="smallButton white-text m-1"
...
.tab-not-active {
  ...
  background: -moz-linear-gradient(
    top,
    rgba(189, 189, 189, 0.65) 0%,
    rgba(189, 189, 189, 0.64) 1%,
