  ...
  <main id="docapp" class="blue-grey darken-3 testBack" >
    ...
    <div v-if="!selection" class="center-align padding20">
        <div class="transparent padding20">
            ...
            <Image style="max-width: 500px;" img_width="30%"  alt="SmartAPI" img_name="logo-large.svg" class="hide-on-small-only hide-on-med-only"></Image>
            </a>
    ...
    <div class="card-panel grey lighten-4">
        ...
        <div class="card-panel white">
            ...
            @click="url='https://raw.githubusercontent.com/SmartAPI/smartAPI-Specification/OpenAPI.next/versions/smartapi-list.md'; showModal = true ">
                {{ btnTxtExt}}
            </button>
            ...
            <div class="row">
                <div class="card-panel white blue-text col s12 l6 padding20">
                    ...
                    <a target="_blank" href="https://swagger.io/">
                        <Image class="responsive-img circle hoverable" img_width="50%" img_name="swagger-logo.jpeg" alt="swagger v2"></Image>
                    </a>
                ...
                <div class="card-panel white blue-text col s12 l6 padding20">
                    ...
                    <a target="_blank" href="https://www.openapis.org/">
                        <Image class="responsive-img circle hoverable" img_width="50%" img_name="openapi-logo.png" alt="openAPI v3"></Image>
                    </a>
                    <p>Visit the links below for examples and version specification.</p>
        ...
        <div class="card-panel transparent ">
            ...
            <ul class="collection transparent" style="border: none;">
                ...
                <li class="collection-item nextBox padding20">
                    ...
                    <br>
                    <a  class="clearButton" @click.prevent="select('3'); setProgress(30);">NEXT</a>
                </li>
            </ul>
        </div>
        ...
        <div class="card-panel transparent">
            ...
            <div id="submitBox" v-if='todo1 && todo2 && todo3' class="card-panel green padding20" style="border-radius: 20px;">
                ...
                <div class="card-panel grey lighten-4 margin20">
                    ...
                    <Image img_name="raw.gif" img_width="300px" alt="raw content" class="responsive-img"></Image>
                </div>
            </div>
