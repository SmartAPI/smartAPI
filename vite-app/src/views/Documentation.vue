      ...
      <div class="testBack padding20">
        <div class="container grey darken-3">
          <ul class="d-flex justify-content-center align-items-center flex-wrap p-1">
            <li class="p-1">
              <router-link to="/documentation"> Introduction </router-link>
            </li>
            <li class="p-1">
              <router-link to="/documentation/getting-started">
                <i class="material-icons tiny">brightness_1</i> Getting Started
              </router-link>
            </li>
            <li class="p-1">
              <router-link to="/documentation/smartapi-extensions">
          ...
          <template v-if="!url">
            ...
            <div class="center-align">
              ...
              <p class="intro-text blue-grey-text">
                ...
                <a href="https://www.openapis.org/" target="_blank">Open API specification v3 </a>
                and <a href="http://json-ld.org" target="_blank">JSON-LD</a> for providing
                semantically annotated JSON content that can be treated as
                <a href="http://linkeddata.org/" target="_blank">Linked Data</a>.
              </p>
              <hr />
              <h4 class="blue-grey-text center-align">
