<template>
  <main id="dashApp" style="min-height: 90vh" class="grey lighten-2" v-cloak>
            ...
            <h5 v-if="userInfo?.name" style="margin-left: 10px">
              <b>
                ...
                <a target="_blank" :href="'https://github.com/' + userInfo.login">{{
                  userInfo?.name.split(' ')[0] || userInfo.login
                }}</a
                >!
              </b>
            </h5>
        ...
        <div class="container row" style="margin: auto">
          <div class="p-1 col s12">
            <input
              ...
              type="text"
              class="browser-default margin20 grey darken-1 l-blue-text lighter"
              style="
                width: 40%;
                outline: none;
                padding: 10px;
                ...
                <tr v-for="(api, index) in results" :key="api.info.title + index">
                  <td>
                    <h6 class="left-align">
                      ...
                      >&nbsp;
                      <small>
                        <span class="grey-text">V {{ api.info.version }}</span> </small
                      >&nbsp; <small v-if="api?.openapi" class="green-text"> OAS3 </small>&nbsp;
                      <small v-else-if="api?.swagger" class="blue-text"> Swagger2 </small>&nbsp;
                      <button class="smallButton" @click="getDetails(api)">settings</button>
                    </h6>
                  </td>
                  <td>
                    <small>
                  ...
                  <td>
                    <button
                      type="button"
                      class="btn btn-small tipped green scale-in-center"
                      data-tippy-info="<b class='green-text'>Refresh</b> <br/>(Manually update API metadata when a valid change is detected)"
                  ...
                  <td>
                    <button
                      type="button"
                      @click="validate(api._meta.url)"
                      class="btn btn-small scale-in-center indigo white-text tipped"
                  ...
                  <td>
                    <button
                      type="button"
                      @click="checkUptime(api._id)"
                      class="btn btn-small scale-in-center deep-purple white-text tipped"
                  ...
                  <td class="right-align">
                    <UptimeStatus
                      ...
                      :uptime_status="api?._status?.uptime_status"
                      :err_msg="api?._status?.uptime_msg"
                    ></UptimeStatus>
    ...
    <div class="blue-grey darken-2 padding20 white-text center">
      <p>
        <i class="material-icons">error_outline</i> Did you know you can set a custom slug for your
        API's documentation? It's easy! Just click on any API on your dashboard and go to the
        <em>Settings</em> tab.<br />
        Use the <em>Custom Slug Registration Wizard</em> and get a custom URL for your API's
        documentation. E.g. <b>&lt;slug&gt;.smart-api.info</b>
      </p>
    </div>
          ...
          <div class="row">
            <div class="col s12">
              <ul class="tabs transparent">
                <li class="tab col s3" @click="tabSelected = 1">
                  <a href="javascript:void(0);" class="active blue-text">API Metadata</a>
                </li>
                <li class="tab col s3" @click="tabSelected = 2">
                  <a class="blue-text" href="javascript:void(0);">Slug Registration</a>
                </li>
                <li class="tab col s3" @click="tabSelected = 3">
                  <a class="blue-text" href="javascript:void(0);">User Interactions</a>
                </li>
                <li class="tab col s3" @click="tabSelected = 4">
                  <a class="blue-text" href="javascript:void(0);">Delete</a>
                </li>
              </ul>
            </div>
                ...
                <li class="collection-header padding20">
                  ...
                  <h2 class="blue-text flow-text">
                    ...
                    <span class="versionBadge grey hide-on-small-only"
                      >Version {{ selectedAPI.info.version }}</span
                    >
                    <span v-if="selectedAPI?.openapi" class="versionBadge green hide-on-small-only">
                      OAS3
                    </span>
                    <span
                      v-else-if="selectedAPI?.swagger"
                      class="versionBadge blue hide-on-small-only"
                    >
                      Swagger2
                    </span>
                    <template class="show-on-small hide-on-med-and-up">
                      <span
                        v-if="selectedAPI?.openapi"
                        class="versionBadge green hide-on-med-and-up"
                      >
                        V3
                      </span>
                      <span
                        v-else-if="selectedAPI?.swagger"
                        class="versionBadge blue hide-on-med-and-up"
                      >
                        V2
                      </span>
                    </template>
                  ...
                  <template v-if="selectedAPI?.swagger">
                    <div class="yellow lighten-5 smallFont padding20">
                      APIs in Swagger V2 specification will experience limited functionality.
                      <br />We recommend you update your metadata to OpenAPI V3 specification.
                      <br />
                      <a
                        target="_blank"
                        class="underlined"
                      ...
                      ></a>
                      <br />
                      <router-link to="/guide" class="green-text underlined"
                        >Use our guide to help you convert your API to OpenAPI V3
                        specification.</router-link
                      >
                    </div>
                    <hr />
                  </template>
                  <div class="d-flex padding20" style="justify-content: center">
                    ...
                    <div class="grey lighten-3 p-1 indigo-text">
                      <small v-text="selectedAPI._id"></small>
                    </div>
                    <CopyButton copy_msg="API ID copied" :copy="selectedAPI._id">
                      <template v-slot:title>
                        Copy API ID <i class="fa fa-clipboard" aria-hidden="true"></i>
                      </template>
                    </CopyButton>
                  </div>
                  <router-link :to="'/ui/' + selectedAPI._id" class="btn blue m-2"
                    >View API Documentation</router-link
                  >
                  <router-link :to="'/registry?q=' + selectedAPI._id" class="btn indigo m-2"
                    >View API On SmartAPI Registry</router-link
                  >
                </li>
              </ul>
            </div>
              ...
              <div class="row">
                ...
                <div v-if="!hasShortName" class="col s12 m12 l12 center-align">
                  ...
                  <p class="grey-text left-align">
                    ...
                    <span class="blue-text"><b>your-api-id</b>.smart-api.info</span> it should allow
                    users to view your API documentation.
                  </p>
                  <p class="grey-text left-align">
                    You can also register a unique slug to make sharing your API easier.
                    <br />
                    If you go to <span class="blue-text"><b>your-slug</b>.smart-api.info</span>, it
                    will take users to your API documentation.
                  </p>
                  <a
                    v-if="!createOrEditMode"
                    @click.prevent="createOrEditMode = !createOrEditMode"
                    class="blue btn"
                    >Create a new slug</a
                  >
                  <a
                ...
                <div v-if="hasShortName" class="col s12 m12 l12">
                  ...
                  <div class="green-text flow-text">
                    <a
                      :href="'http://' + selectedAPI._meta.slug + '.smart-api.info'"
                      target="_blank"
                      class="green-text link"
                      >http://<b>{{ selectedAPI._meta.slug }}</b
                      >.smart-api.info <i class="fa fa-external-link-square" aria-hidden="true"></i
                    ></a>
                    <br />
                    <hr />
                    <a
                      class="btn green smallFont margin20"
                      @click.prevent="createOrEditMode = !createOrEditMode"
                      >Edit Slug</a
                    >
                    <a
                      v-if="hasShortName"
                      class="btn red smallFont margin20"
                      @click.prevent="deleteSlug"
                      >Delete Slug</a
                    >
                  </div>
                </div>
                <div
                  v-if="createOrEditMode && !hasShortName"
                  style="
                    width: 100%;
                    display: flex;
                    align-items: center;
                ...
                >
                  <div class="left-align padding20 grey-text" style="flex: 1; min-width: 100%">
                    Slug length must be 4-50 characters (a-z) and/or numbers (0-9). Slugs will be
                    converted to lower case. URL protected characters not allowed.
                  </div>
                  <div style="flex: 1; min-width: 200px">
                    <input
                      ...
                      type="text"
                      class="disabled browser-default margin20 grey lighten-5 blue-grey-text lighter"
                      style="
                        width: 85%;
                        outline: none;
                        padding: 10px;
                  ...
                  <div style="flex: 1; min-width: 200px">
                    <p
                      id="availabilityResults"
                      v-bind:class="{
                        'green-text': availableShortName,
                        'red-text': !availableShortName
                      }"
                    >
                      ...
                      <i
                        v-if="availableShortName && myShortName"
                        class="fa fa-thumbs-up green-text"
                        aria-hidden="true"
                      ></i>
                      <i
                        v-if="!availableShortName && myShortName"
                        class="fa fa-thumbs-down red-text"
                        aria-hidden="true"
                      ></i>
                      <br />
                      <span
                        v-if="myShortName.length < 3 && myShortName.length > 0"
                        class="amber-text"
                        ><i class="tiny material-icons">warning</i> Too Short</span
                      >
                      <span v-if="myShortName.length > 50" class="orange-text"
                        ><i class="tiny material-icons">warning</i> Too Long</span
                      ><br v-if="myShortName.length <= 3 && invalidChars" />
                      <span v-if="invalidChars" class="red-text"
                        ><i class="tiny material-icons">warning</i> Invalid Characters</span
                      >
                      <span v-if="takenSlug" class="orange-text"
                        ><i class="tiny material-icons">warning</i> Taken Slug</span
                      >
                    </p>
                  </div>
                  <div style="flex: 1; min-width: 200px">
                    <button
                      type="button"
                      class="btn"
                      @click.prevent="setShortname"
                      :disabled="!availableShortName && !hasShortName"
                      :class="!availableShortName ? 'grey' : 'green white-text'"
                    >
                      Set Slug
                    </button>
                  </div>
                  ...
                  <div
                    id="shortNameSuccess"
                    class="center-align padding20 green smallFont"
                    style="flex: 1; min-width: 100%; display: none"
                  >
                    <h5 class="white-text">
                      <i class="fa fa-check white-text" aria-hidden="true"></i> Slug Registered
                    </h5>
                    <a href="javascript:void(0)" class="btn green modal-action modal-close"
                      >Close</a
                    >
                  </div>
                </div>
            ...
            <div v-show="tabSelected == 3" id="test3" class="col s12 white">
              <div class="row">
                ...
                <div>
                  <SummaryChart
                    :key="selectedAPI.info.title"
                    :data="[]"
                    summary_type="User_Interactions"
                    :colors="['#20c96a', '#2c98f0', '#4bc0c0', '#8d5bd4']"
                    :apiname="selectedAPI.info.title"
                  ></SummaryChart>
                  <div>
                    <small
                      >Views = Viewed API details on regsitry, Documentation = Viewed API
                      documentation, Searched = Searched API by name</small
                    >
                  </div>
                </div>
              </div>
            ...
            <div v-show="tabSelected == 4" id="test4" class="col s12 white">
              <ul class="collection with-header">
                <li class="collection-item deep-orange lighten-2">
                  <h5>Danger Zone</h5>
                  <p>
                    Delete API metadata from SmartAPI registry permanently. This action cannot be
                    undone.
                  </p>
                  <button
                    type="button"
                    @click="deleteForever(selectedAPI.info.title, selectedAPI._id)"
