    ...
    <nav>
        <div class="nav-wrapper blue">
            ...
            <li class="collection-item noBorder transparent">
                ...
                id="extBtn"
                class="link"
                @click="url='https://raw.githubusercontent.com/SmartAPI/smartAPI-Specification/OpenAPI.next/versions/smartapi-list.md'">
            ...
            <li class="collection-item noBorder transparent">
                ...
                id="extBtn"
                class="link"
                @click="url='https://raw.githubusercontent.com/SmartAPI/smartAPI-Specification/OpenAPI.next/README.md'">
        ...
        <div class="container white padding20 contentDocs z-depth-4">
            ...
            <hr />
            <div v-if='!url' class="center-align">
