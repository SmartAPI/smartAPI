<template>
    <main id="faq-app" class="white w-100">
...
The SmartAPI Ecosystem for Making Web APIs FAIR. International Semantic Web Conference (Posters, Demos & Industry Tracks) 2017
        ...
        },
        {
            ...
            },
            {
                ...
                'question':'I edited my metadata on Github, but the raw Github URL does not reflect the changes. Why is that?',
            ...
            {
                'anchor':'api-monitor',
                'question':"How can I construct my API specification so SmartAPI's API monitor can track my API status",
                'answer':`<p>
